...
namespace TodoApi
{
    public partial class dominhannguyenContext : DbContext
    {
        public dominhannguyenContext()
        {
        }

        public dominhannguyenContext(DbContextOptions<dominhannguyenContext> options)
            : base(options)
        {
        }
